		...
		<form class="center_form" action="new_user_form_handler.php" method="POST" id="new_user_from">
			...
			<table cellpadding='10'>
				...
				<tr>
					...
					<td><input type="text" name="username" minlength="4" maxlength="20" required><br><br></td>
				</tr>
				<tr>
					<td>Enter your desired password  </td>
					<td><input type="password" title="8 characters and a number" pattern="[a-zA-Z0-9_.-]*$" name="password" minlength="8" maxlength="20" required><br><br></td>
				</tr>
				<tr>
					<td>Enter your email ID</td>
					<td><input type="email" name="email" minlength="5" required><br><br></td>
				</tr>
			</table>
			<br>
			<table cellpadding='10'>
