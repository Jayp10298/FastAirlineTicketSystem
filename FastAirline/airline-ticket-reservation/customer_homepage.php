...
<html>
	...
	<body>
		...
		<table cellpadding="5">
			<tr>
				<td class="admin_func"><button style="height:30px;"><a href="book_tickets.php"><i class="fa fa-plane" aria-hidden="true"></i> Book Flight Tickets</a></button>
				</td>
			</tr>
			<tr>
				<td class="admin_func"><button style="height:30px;"><a href="view_booked_tickets.php"><i class="fa fa-plane" aria-hidden="true"></i> View Booked Flight Tickets</a></button>
				</td>
			</tr>
			<tr>
				<td class="admin_func"><button style="height:30px;"><a href="cancel_booked_tickets.php"><i class="fa fa-plane" aria-hidden="true"></i> Cancel Booked Flight Tickets</a></button>
				</td>
			</tr>
		</table>
